...
export const siteConfig: SiteConfig = {
	title: "Kirityou7's Demo Site",
	subtitle: "",
	siteURL: "https://kirityou7.github.io/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-12-09", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bangumi: {
		userId: "kirityou7", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	},
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Kirityou7",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/39353567",
					external: true,
